...
{
    public class SetStructProjectionModel : StructProjectionModel
    {
        public string Pattern { get; set; }
        
        public ReactiveCommand<string, IList<SetStructItemModel>> ScanCommand { get; set; }
        
        public ReactiveCommand<Unit, bool> AddCommand { get; set; }
        
        public ReactiveCommand<List<SetStructItemModel>, List<SetStructItemModel>> DeleteCommand { get; set; }
        
        public ReactiveCommand<SetStructItemModel, (SetStructItemModel, SetStructItemModel)> EditCommand { get; set; }
        
        public ReactiveCommand<Unit, List<SetStructItemModel>> CancelCommand { get; set; }
        ...
        public ObservableCollectionExtended<SetStructItemModel> SetItems { get; set; }
            = new ObservableCollectionExtended<SetStructItemModel>();
        
        public SetStructProjectionModel(StructProjectionInfo structProjectionInfo)
        {   
            var controller = new SetStructProjectionController(this);
